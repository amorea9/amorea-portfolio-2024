...
export default function Projects() {
  return (
    <div id="projects" className="h-fit pt-10 xl:pt-5 scroll-m-14 w-full">
      <article className="flex flex-col text-center md:text-left items-center md:items-left mx-10 gap-8 h-full lg:pb-12 pb-20 sm:gap-16    lg:pt-10 lg:gap-18 sm:flex-wrap lg:gap-18 md:flex-row  xl:mx-44 ">
