    ...
    <div>
      <div className="relative flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md gap-4">
        ...
        <div className="px-5 pb-5 flex flex-col items-center">
          <a href="#">
            <h5 className="text-xl text-slate-900">{project.title}</h5>
          </a>
          <div className="mt-2 mb-5 flex items-center justify-between">
            <p>
              <span className="text-base  text-slate-900">{project.description} </span>
            </p>
          </div>
          <a href="#" className="rounded-md bg-limeGreen px-5 py-3 text-center text-sm font-medium hover:bg-lime-300 w-full transition-all duration-300 hover:shadow-md">
            {project.cta}
          </a>
        </div>
      </div>
